<xsl:stylesheet version='1.0'
  ...
  xmlns:api="http://github.com/smoe/apibaso"
>
...
<i>Caveat: Only edit sorting data in the apibaso.xml file or send the maintainer an email.
   This HTML file is autogenerated, editing the HTML directly would likely lead to a loss of those changes.</i>
</p>
 ...
 <xsl:template match="api:variantlist">
    <table width="80%" border="1" cellpadding="2" align="center" >
	    <tr bgcolor="orange"><th>Gene / Gene Product (Tissue)</th><th>References</th><th>Location</th><th>Responsible sequence</th></tr>
